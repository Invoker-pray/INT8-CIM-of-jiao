...
```bash
cd <project_root> && bash picorv32/hw/scripts/vivado_build_mzu15b.sh

# Output: picorv32/vivado_mzu15b_proj/deploy/cim_rv32_mzu15b.bit
```
...
1. Open in Vivado GUI: `vivado picorv32/vivado_mzu15b_proj/cim_rv32_mzu15b.xpr`
...
|-----------|---------|--------|--------|
| MAX_IN_DIM | 1536 | **3072** | 3× larger; fits 744 BRAM36 (26.2Mb) |
| MAX_OUT_DIM | 256 | **1024** | 4× larger; larger FC layers and channels |
| PAR_OB | 4 | **13** | 3528 DSP → 3328 used (94%) |
...
│   ├── scripts/
│   │   └── vivado_build_mzu15b.tcl # MZU15B PicoRV32 build
│   │   └── vivado_build_mzu15b.sh
│   └── constraints/
