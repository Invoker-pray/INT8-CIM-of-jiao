...
# ============================================================================
# Usage: cd <project_root> && bash picorv32/hw/scripts/vivado_build_mzu15b.sh
#
# Prerequisites:
...
rm -rf "${PROJECT_ROOT}/picorv32/vivado_mzu15b_proj" "${PROJECT_ROOT}/.Xil"

# ---- MZU15B: PAR_OB=13 pushes to 94% DSP (13×256=3328 of 3528) ----
echo "  PAR_OB=13 (MZU15B has 3528 DSP → 13×256=3328 used, 94%)"

# ---- Run Vivado ----
cd "${PROJECT_ROOT}"
mkdir -p picorv32/vivado_mzu15b_proj

${VIVADO_BIN} -mode batch \
    -source picorv32/hw/scripts/vivado_build_mzu15b.tcl \
    -log picorv32/vivado_mzu15b_proj/vivado_build.log \
    -journal picorv32/vivado_mzu15b_proj/vivado_build.jou

echo ""
echo "============================================================"
echo "Build finished."
echo "  Log       : picorv32/vivado_mzu15b_proj/vivado_build.log"
echo "  Bitstream : picorv32/vivado_mzu15b_proj/deploy/cim_rv32_mzu15b.bit"
echo ""
echo "Program FPGA (via JTAG / openFPGALoader):"
echo "  openFPGALoader -b <board> picorv32/vivado_mzu15b_proj/deploy/cim_rv32_mzu15b.bit"
echo ""
