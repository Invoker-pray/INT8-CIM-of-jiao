...
set OUT_DIR    "mzu15b/vivado_rv32_proj"

puts "============================================================"
puts "CIM SoC — MZU15B Build (PicoRV32 control)"
puts "  Part:   ${PART}"
puts "  FCLK:   ${FCLK_MHZ} MHz"
puts "  Params: MAX_IN_DIM=4096, MAX_OUT_DIM=1024, PAR_OB=8"
puts "============================================================"
...
add_files -fileset constrs_1 -norecurse mzu15b/hw/constraints/cim_rv32_mzu15b.xdc

set_property file_type SystemVerilog [get_files *.sv]
set_property file_type Verilog       [get_files *.v]

# Define MZU15B to enable expanded parameters in cim_pkg.sv
set_property verilog_define {MZU15B} [get_files ${CIM_HW}/rtl/pkg/cim_pkg.sv]
...
if {!$board_auto_ok} {
    ...
    puts "WARN:   1. vivado mzu15b/vivado_rv32_proj/cim_rv32_mzu15b.xpr"
...
# Set FREQ_HZ for timing propagation
...
puts ""
puts "Parameters:"
puts "  MAX_IN_DIM=4096, MAX_OUT_DIM=1024, PAR_OB=8, FCLK=${FCLK_MHZ}MHz"
