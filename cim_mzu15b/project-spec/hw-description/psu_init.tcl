...
set psu_mio_init_data {
    ...
    mask_write 0XFF180204 0x0061E000 0x00000000
    ...
    mask_write 0XFF180208 0x000FC78C 0x00000004
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF180310 0x00008001 0x00008000
    ...
    mask_write 0XFF180320 0x33843384 0x12840080
		# : SD0 BASE CLOCK
