...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180204, 0x0061E000U ,0x00000000U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI0_OFFSET,
		0x0061E000U, 0x00000000U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180208, 0x000FC78CU ,0x00000004U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI1_OFFSET,
		0x000FC78CU, 0x00000004U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_CTRL_REG_SD_SD1_EMMC_SEL                       1

    * SD eMMC selection
    * (OFFSET, MASK, VALUE)      (0XFF180310, 0x00008001U ,0x00008000U)
    */
	PSU_Mask_Write(IOU_SLCR_CTRL_REG_SD_OFFSET,
		0x00008001U, 0x00008000U);
/*##################################################################### */
    ...
    * Should be set based on the final product usage 00 - Removable SCard Slot
    *  01 - Embedded Slot for One Device 10 - Shared Bus Slot 11 - Reserved
    *  PSU_IOU_SLCR_SD_CONFIG_REG2_SD1_SLOTTYPE                    1
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180320, 0x33843384U ,0x12840080U)
    */
	PSU_Mask_Write(IOU_SLCR_SD_CONFIG_REG2_OFFSET,
		0x33843384U, 0x12840080U);
/*##################################################################### */
