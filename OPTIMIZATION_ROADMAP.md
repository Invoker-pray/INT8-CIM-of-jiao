...
**Regression:** PASS (3/3). **Committed:** `a416ca2`. **Bitstream:** `bitstream&hwh/checkpoint12/`. WNS=-0.747, WHS=0.011. On-board test pending.
...
| ✅ DONE | Phase C: Layer Fusion — OBUF→IBUF 内部直拷, 消除 FC→FC DMA round-trip | RTL v8 DONE (tile_idx pipeline fix, regression PASS), bitstream built (checkpoint12, WNS=-0.747), on-board test pending | 中 | 1w | 2026-05-10 |
