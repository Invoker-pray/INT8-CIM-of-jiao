...
## 1.5 Phase C: Layer Fusion — OBUF→IBUF 内部直拷 — 🟢 PASS (2026-05-10)
...
| ✅ DONE | MZU15B 移植 (XCZU15EG) — PicoRV32 ✅, ARM-direct ✅, MAX_IN_DIM=3072, PAR_OB=13, 100MHz | 双版本 bitstream 均生成, picorv32/ 整合完成, 待上板验证 | 中 | 2w | 2026-05-17 |
