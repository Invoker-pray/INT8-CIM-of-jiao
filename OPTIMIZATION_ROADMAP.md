...
## 1.5 Phase C: Layer Fusion — OBUF→IBUF 内部直拷 — 🟡 RTL v10 完成, 待上板验证 (2026-05-10)
...
**Regression:** PASS (3/3). **Committed:** `19d5391`. **Bitstream:** `bitstream&hwh/checkpoint14/`. WNS=-0.911, WHS=0.031, LUT 32.66%, FF 10.25%, BRAM 88.21%, DSP 100%. **On-board test: PENDING.**
